...
import { BorderNoteText, Paragraph, SubTitle, Title } from "utils/legal-styles";

export default function PolitiqueProtectionDonnees() {
    return (
        <Web>
            <Section>
                <Section.Content>
                    ...
                    <Paragraph>Cette Politique a pour but de présenter aux Personnes concernées telles que définies ci-après :</Paragraph>
                    <ul className={'mt-li'}>
                        <li>
                    ...
                    <SubTitle>3. Quelles sont les catégories de Données à caractère personnel collectées ?</SubTitle>
                    ...
                    <Paragraph>4. Moyens de collecte des Données à caractère personnel</Paragraph>
                    ...
                    <SubTitle>5. Finalités de traitements et bases juridiques</SubTitle>
                    ...
                    <ul className={'mt-li'}>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>la lutte contre la fraude, les abus, en ce incluant également la gestion des conséquences de cette fraude ou de ces abus ;</li>
                                <li>la gestion des atteintes à la sécurité ou tout problème d’ordre technique rencontré par les Produits ou Services ;</li>
                                <li>la réalisation d’opérations de prospection commerciale à destination des professionnels ;</li>
                                <li>la gestion des clients ou des employés au sein d’un groupe d’entreprises à des fins de gestion administrative interne ;</li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>La gestion des demandes d’aides permettant de faciliter l’accomplissement des formalités administratives nécessaires au traitement des demandes des utilisateurs ;</li>
                                <li>la gestion des communications et le suivi des échanges avec les utilisateurs ;</li>
                                <li>le respect de la réglementation applicable à notre activité.</li>
                            </ul>
                        </li>
                    ...
                    <SubTitle>6. Combien de temps les Données à caractère personnel sont-elles conservées ?</SubTitle>
                    <Paragraph>
                    ...
                    <table className={'table-rgpd'}>
                        <thead>
                            <tr>
                                <th>Finalités</th>
                                <th>Durées de conservations</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><b>Gestion de la relation des utilisateurs des Sites de l’ADEME</b></td>
                                <td>
                    ...
                    <BorderNoteText style={{ fontWeight: 'normal', borderColor: '#ccc' }}>
                        <Paragraph>
                    ...
                    <Paragraph>
                        ...
                        <br />
                        ADEME <br />
                        Délégué à la Protection des Données/Data <br />
                        Protection Officer 20, avenue du Grésillé — BP <br />
                        90406 - 49004 Angers Cedex 01 ou par Email à <br />
                        l’adresse suivante : rgpd@ademe.fr
                    </Paragraph>
                    ...
                    <SubTitle>11. Liens pour accéder à d'autres sites</SubTitle>
                    ...
                    <SubTitle>12. Modifications</SubTitle>
                    <Paragraph>L’ADEME se réserve le droit d’adapter la présente Politique.</Paragraph>
                    ...
                    <Paragraph>L’ADEME vous invite donc à consulter régulièrement les supports concernés où est publiée la Politique.</Paragraph>
                </Section.Content>
            </Section>
        </Web>
    )
